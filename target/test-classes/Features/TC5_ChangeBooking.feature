...
@Change
  Scenario Outline: Modify the Created Order Id - Book hotel by card (credit card)
    ...
    Examples: 
      ...
      | banupriyasr90@gmail.com | Banu@123| Tamil Nadu | Chennai | Standard | 2024-10-15 | 2024-10-20 | 2-Two | 1-One |             3 |Ms. | Banupriya | Tamilarasan | 9698963873 | banu@123 | 9043592058 |  Greens Tech OMR Branch| Thoraipakkam | want large room | debit_card | 2024-10-17 |

  Scenario Outline: Modify the Created Order Id - Book hotel by  (UPI ID)
    Given User is on the OMR Branch hotel page
    When User login "<userName>" and "<password>"
    Then User should verify success message after login "elcome Greens"
    When User search hotel "<state>","<city>","<roomType>","<checkIn>","<check-out>","<No of Room>","<No of Adults>" and "<No of Childs>"
    Then User should verify after search hotel success message "Select Hotel"
    When User save the last hotel name and hotel price
    And User select the last hotel and accept the alert
    ...
    Examples: 
      ...
      |banupriyasr90@gmail.com  | Banu@123 | Tamil Nadu | Chennai | Standard | 2024-10-15 | 2024-10-20 | 2-Two| 1-One |              3  |Ms.  | Banupriya | Tamilarasan | 9698963873 | banu@123 | 9043592058 | Greens Tech OMR Branch | Thoraipakkam| want large room| seleniumtraining@vbc | 2024-10-17 |
  ...
  Scenario Outline: Modify the Created Order Id - Book hotel by card (credit card) without GST and  with special request
    ...
    Examples: 
      ...
      | banupriyasr90@gmail.com  | Banu@123 | Tamil Nadu | Chennai | Standard | 2024-10-15 | 2024-10-20 | 2-Two | 1-One |               3  | Ms. | Banupriya  | Tamilarasan| 9698963873 | banu@123 |want large room  | debit_card | 2024-10-17 |
  ...
  Scenario Outline: Modify the Created Order Id - Book hotel by card (credit card) without special request and with GST
    ...
    Examples: 
      ...
      | banupriyasr90@gmail.com  |Banu@123  | Tamil Nadu | Chennai | Standard | 2024-10-15 | 2024-10-20  |2-Two |1-One  |                3 | Ms.| Banupriya | Tamilarasan | 9698963873 | banu@123 | Credit Card | 2024-10-17 |
  ...
  Scenario Outline: Modify the Created Order Id - Book hotel by card (credit card) without special request and GST
    ...
    Examples: 
      | userName | password | state | city | roomType | checkIn | check-out | No of Room | No of Adults | No of Childs | Select Salutation | First Name | Last Name | Mobile No. | Email | Enter Registration No. | Enter Company Name | Enter Company Address | Request | Card Type | Modify Date |
      |  banupriyasr90@gmail.com |Banu@123  |  Tamil Nadu | Chennai | Standard |  2024-10-15 | 2024-10-20 | 2-Two | 1-One | 3| Ms. | Banupriya | Tamilarasan | 9698963873 |  banu@123|  | Enter Company Name | Enter Company Address | Request | Card Type | Modify Date |
  ...
  Scenario Outline: Modify the Created Order Id - Book hotel by  (UPI ID) without special request and GST
    ...
    Examples: 
      | userName | password | state | city | roomType | checkIn | check-out | No of Room | No of Adults | No of Childs | Select Salutation | First Name | Last Name | Mobile No. | Email | Enter Registration No. | Enter Company Name | Enter Company Address | Request | upiId | Modify Date |
      |  | password | state | city | roomType | checkIn | check-out | No of Room | No of Adults | No of Childs | Select Salutation | First Name | Last Name | Mobile No. | Email | Enter Registration No. | Enter Company Name | Enter Company Address | Request | upiId | Modify Date |
  ...
  Scenario Outline: Modify Check-in Date for existing Order ID
    ...
    Examples: 
      ...
      | banupriyasr90@gmail.com | Banu@123  | 2024-10-17 |
